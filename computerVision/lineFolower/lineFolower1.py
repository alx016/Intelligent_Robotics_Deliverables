...
def imageProcessing():
    ...
    img = cv.line(img, (int(detectR), 0), (int(detectR), height), (255,0,0),2) # BLUE LINE
    img = cv.line(img, (int(detectL), 0), (int(detectL), height), (255,0,0),2) # BLUE LINE
    detect3 = (detectL + detectR)/2
    img = cv.line(img, (int(detect3), 0), (int(detect3), height), (0,0,255),2) # RED
